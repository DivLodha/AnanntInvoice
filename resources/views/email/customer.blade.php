                ...
                <div class="card-body p-0">
                    <div class="row p-2">
                        ...
                        <div class="col-md-6 text-left">
                            ...
                            <h3 class="mb-1" style="color:#0000be">Anannt Training Institute</h3>
                            <p class="text-muted mb-1">Second floor, Sudarshan Building		
                                                    Shila Vihar colony, Kothrud, Pune-38</p>		
                            <p class="text-muted">0960 760 39 39</p>
                        ...
                        <div class="col-md-12">
                            <table class="table">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        <td>Total Fee</td>
                                        <td><span class="font-weight-bold">₹ {{$invoice->total_fee}}</span></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="font-weight-bold">₹ {{$invoice->discounted_fee}}</span></td>
                                        <td><span class="font-weight-bold">₹ {{$invoice->paid_amount}}</span></td>
                                        <td><span class="font-weight-bold">₹ {{$invoice->due_amount}}</span></td>
                                    ...
                                    <!-- <tr>
                                        <td></td>
                                        <td></td>
                                        <td><span class="font-weight-bold">₹ {{$record->paid_amount}}</span></td>
                                        <td><span class="font-weight-bold">₹ {{$record->due_amount}}</span></td>
                                    </tr> -->
                    ...
                    <div class="py-3 px-5 text-right">
                            ...
                            <div class="h2 font-weight-light">₹ {{$invoice->paid_amount + $invoice->previous_paid}}</div>
                        </div>
                        @if($invoice->discount_amount != 0)
                        <div class="py-3 px-5 text-right">
                            <div class="mb-2">Total Discount</div>
                            <div class="h2 font-weight-light">₹ {{$invoice->discount_amount}}</div>
                        </div>
                         <!-- <div class="py-3 px-5 text-right">
                            <div class="mb-2">Discounted Price</div>
                            <div class="h2 font-weight-light">₹ {{$invoice->discounted_fee}}</div>
                        </div> -->
                        @endif
                        </div>
                    <div class="text-dark text-center" style="padding: 10px;">
                        <h6 >Thank you for choosing Anannt Training Institute!</h6>
                        <br>   
                    </div>

            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <form action="{{admin_url('invoice/store')}}/{{$record->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                       ...
                                       foreach ($course->sortBy('course_sort_order') as $item){ 
                                          ?>
                                           <div class="col-sm-12 course_container" id="course_container{{$count}}" data-count="{{$count}}">
                                                ...
                                                <div class="form-group col-sm-6"> 
                                                <input type="text" name="course{{$count}}_name" id="course{{$count}}_name" placeholder="Course Name" value="{{old('course_name',$item->course_name)}}" class="form-control input-md" readonly required> 
                                                </div>
                                                <div class="form-group col-sm-6"> 
                                                <input type="text" name="course{{$count}}_fee" id="course{{$count}}_fee" placeholder="Course Fee" value="{{old('course_fee',$item->course_fee)}}" class="form-control input-md" readonly required> 
                                                </div>
                                                <div class="form-group col-sm-4"> 
                                                <input type="number" name="course{{$count}}_sort_order" id="course{{$count++}}_sort_order" placeholder="Row No" value="{{old('course_sort_order',$item->course_sort_order)}}" class="form-control input-md hide" readonly required> 
                                                </div>
                                                <hr>
                                        </div>
                                        <?php 
                                       ...
                                       <a href="javascript:;" id="add_billing" class="btn"><i class="fa fa-plus-circle" id="section_icon"></i>
                                        ...
                                        <div class="form-group col-sm-6">
                                         ...
                                         <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="previous_paid" id="previous_paid" placeholder="Total Paid Amount" title="Total Paid Amount" value="{{old('previous_paid',$record->paid_amount)}}" class="form-control input-md" required readonly>
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <label for="total_fee">Previous Due Amount : </label>
                                            <input type="number" name="previous_deu" id="previous_deu" placeholder="Total Due Amount" title="Total Due Amount" value="{{old('due_amount',$record->due_amount)}}" class="form-control input-md" required readonly>
                                         </div>

                                         <div class="form-group col-sm-6">
                                            <label for="Discounted FEE">Previous Discount : </label>
                                            <input type="number" name="previous_discount" id="previous_discount" placeholder="Total Discount" title="Total Discount" value="{{old('discounted_fee',$record->discount_amount)}}" class="form-control input-md" required readonly>
                                         </div>

                                         <div class="form-group col-sm-6">
                                            <label for="Discounted FEE">Previous Discounted FEE : </label>
                                            <input type="number" name="previous_discounted_fee" id="previous_discounted_fee" placeholder="Previous Discounted Fee" title="Previous Discounted Fee" value="{{old('discounted_fee', $record->discounted_fee)}}" class="form-control input-md" required readonly>
                                         </div>
                                         ...
                                         <div class="form-group col-sm-6" id="discount_amount_div" style="display:none">
                                            <label for="Discount Amount">Current Discount : </label>
                                            <input type="number" name="discount_amount" id="discount_amount" placeholder="Discount Amount" title="Discount Amount" value="" class="form-control input-md" required>
                                         </div>

                                         <div class="form-group col-sm-6">
                                            <label for="Discounted FEE">Total Discount : </label>
                                            <input type="number" name="total_discount" id="total_discount" placeholder="Total Discount" title="Total Discount" value="" class="form-control input-md" required readonly>
                                         </div>

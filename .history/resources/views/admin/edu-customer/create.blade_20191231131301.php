                                    ...
                                    @csrf
                                       ...
                                       <a href="javascript:;" id="add_billing" class="btn"><i class="fa fa-plus-circle" id="section_icon"></i>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="total_fee" id="total_fee" placeholder="Total Fee" value="" class="form-control input-md" required readonly>
                                         </div>
                                         <div class="form-group col-sm-6">
                                         ...
                                         <div class="form-group col-sm-6" id="discount_amount_div" style="display:none">
                                            ...
                                            <input type="number" name="discount_amount" id="discount_amount" placeholder="Discount Amount" value="" class="form-control input-md" >
                                         </div>
                                         <div class="form-group col-sm-6">
                                         ...
                                         <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="discounted_fee" id="discounted_fee" placeholder="Discounted Fee" value="" class="form-control input-md" required readonly>
                                         </div>
                                         <input type="hidden" name="discounted_fee_before_vat" id="discounted_fee_before_vat" placeholder="Discounted Fee" value="">
                                        <div class="form-group col-sm-6">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="paid_amount" id="paid_amount" placeholder="Paid Amount" value="" class="form-control input-md" required>
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <label for="due_amount">Due Amount : </label>
                                            <input type="number" name="due_amount" id="due_amount" placeholder="Due Amount" value="" class="form-control input-md" required readonly>
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <label for="due_date">Due Date : </label>
                                            <input type="date" name="due_date" id="due_date" placeholder="Due Date" value="" class="form-control input-md">
                                         </div>
                                         <div class="form-group col-sm-12">
                                            <label for="note">Note : </label>
                                            <input type="text" name="note" id="note" placeholder="Note" value="" class="form-control input-md">
                                         </div>
...
<script type="text/javascript">
    ...
    //  });
     ...
     $("#vat").on('change', function(){
        ...
        if($(this).val() == "1"){
            var total = Number($("#discounted_fee").val());
            vat = total*0.05;
            total = total+vat;
            $("#discounted_fee").val(total);
        }
     ...
     $(document).on('click', '#discounted_fee', function(){
        ...
        }else if($("#discount option:selected").text()== "0%"){
            var total = Number($("#total_fee").val());
            $("#discounted_fee").val(total);
        }
    });

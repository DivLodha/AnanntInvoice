                        ...
                        <form action="{{route('customer.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                       <div class="form-group col-sm-6">
                                        ...
                                        <div class="form-group col-sm-6">
                                         ...
                                         <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="contact" id="contact" placeholder="Contact" title="Contact" value="" class="form-control input-md" required>
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <!-- <label for="name">Contact : </label> -->
                                            <input type="text" name="school" id="school" placeholder="School/College" title="School/College" value="" class="form-control input-md">
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <!-- <label for="name">Contact : </label> -->
                                            <input type="text" name="city" id="city" placeholder="City" title="City" value="" class="form-control input-md">
                                         </div>
                                       ...
                                       <a href="javascript:;" id="add_billing" class="btn"><i class="fa fa-plus-circle" id="section_icon"></i>
                                        ...
                                        <a href="javascript:void(0)" id="carousels_edit_submit" onclick="btn_click('#carousels-edit','#carousels_edit_submit');" class="btn grey">Submit</a>   

...
class DashboardController extends Controller
{
    ...
    function index(){
       ...
       if(Auth::user()->country == "Dubai"){
        $params['total_customer'] = DubaiCustomer::count(); 
        $params['total_revenue'] = DubaiCustomer::sum('discounted_fee'); 
        $params['total_due'] = DubaiCustomer::sum('due_amount');
        $params['total_paid'] = DubaiCustomer::sum('paid_amount');
        $params['list'] = "";
        $params['total'] = "";
        $params['due_list'] = DubaiCustomer::where('due_amount','!=',0)->get();
       ...
       if(Auth::user()->role == 1){
        ...
        $params['admin'] = "No";
        return view('admin.employee-dashboard',$params);  
       }
